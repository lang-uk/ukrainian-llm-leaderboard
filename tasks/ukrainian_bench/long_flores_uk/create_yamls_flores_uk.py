...
def doc_to_text(src: str, tgt: str) -> str:
    ...
    return f"""\
{src_name} text: {jinja_var("sentence_" + src)}
{tgt_name} text:"""
...
def gen_lang_yamls(output_dir: str, overwrite: bool) -> None:
    ...
    for src, tgt in LANGUAGE_PAIRS:
        ...
        for src, tgt in [(src, tgt), (tgt, src)]:
            ...
            yaml_file_name = f"long_flores_{lang_pair_name}.yaml"
            ...
            try:
                with open(
                    ...
                    yaml.dump(
                        {
                            #                            "group": "flores_es",
                            "include": "_long_flores_common_yaml",
                            "task": f"long_flores_{lang_pair_name}",
